                                        ...
                                        <div class="tab-pane" id="tab_images">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <a href="/static/assets/admin/pages/media/works/img1.jpg" class="fancybox-button" data-rel="fancybox-button">
                                                                <img class="img-responsive" src="/static/assets/admin/pages/media/works/img1.jpg" alt="">
                                                            </a>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="/static/assets/admin/pages/media/works/img2.jpg" class="fancybox-button" data-rel="fancybox-button">
                                                                <img class="img-responsive" src="/static/assets/admin/pages/media/works/img2.jpg" alt="">
                                                            </a>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="/static/assets/admin/pages/media/works/img3.jpg" class="fancybox-button" data-rel="fancybox-button">
                                                                <img class="img-responsive" src="/static/assets/admin/pages/media/works/img3.jpg" alt="">
                                                            </a>
                                                        </td>
                                                        <td>
...
<script>
import Admin_Header from '../admin_layout/admin_header'
import Admin_Footer from '../admin_layout/admin_footer'
import Admin_Sidebar from '../admin_layout/admin_sidebar'
export default {
