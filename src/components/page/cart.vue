                ...
                <table summary="Shopping cart">
                  ...
                  <tr>
                    <td class="goods-page-image">
                      <a href="#"><img src="/static/assets/frontend/pages/img/products/model3.jpg" alt="Berry Lace Dress"></a>
                    </td>
                  ...
                  <tr>
                    <td class="goods-page-image">
                      <a href="#"><img src="/static/assets/frontend/pages/img/products/model4.jpg" alt="Berry Lace Dress"></a>
                    </td>
                    <td class="goods-page-description">
                      <h3><a href="#">Cool green dress with red bell</a></h3>
                      <p><strong>Item 1</strong> - Color: Green; Size: S</p>
